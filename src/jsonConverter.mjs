// import { naoMetais, metaisAlcalinos, semimetais, lantanideos, gasesNobres, metaisAlcalinosTerrosos, halogenios, metaisdeTransicao, actinidios } from './main.js'

function Geral(lineNum, [elNum, numAtom, simAtom, nome, pesoAtom, c]) {
  let array = {
    linha: lineNum,
    data: {
      elemento: elNum,
...
console.log(JSON.stringify(el10));

function GeraJSON(line, element, numAtom, simAtom, nome, pesoAtom, tipo) {
  for (let i = 0; i < 55; i++) {


    return `"${i}": {"linha":${line},"data":{"elemento":${element},"numAtom":${numAtom},"simAtom":${simAtom},"nome":${nome},"pesoAtom":${pesoAtom},"tipo":${tipo}}},`
  }
}

// https://www.youtube.com/watch?v=lxjBgxmDZAI
// https://www.youtube.com/watch?v=Qjk-cSW-jk4
// https://www.youtube.com/watch?v=H84WD_xyj10
// https://www.youtube.com/watch?v=-URfFFxQ3Rk
